...
const saveDeck = async () => {
  if (editingDeck) {
    ...
    updateDeck(editingDeck.value.id, {
    ...
    <div v-if="editingDeck && showCardEditor" class="modal-overlay" @click="closeCardEditor">
      <div class="modal-content" @click.stop>
        <div class="modal-body">
          <CardEditor :cards="cards" :deck="editingDeck" :visible="showCardEditor" @add="addCards" @update="updateCards"
            @delete="removeCards" @cancel="closeCardEditor" @close="closeCardEditor" />
        </div>
      </div>
    </div>
    <!-- 卡组编辑器弹窗 -->
      ...
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" id="deck-name-input" v-model="editingDeckName" class="form-control" />
          </div>
          <div class="form-group">
            <label for="arrangement-input">安排数量</label>
            <input type="number" id="arrangement-input" v-model="editingDeckArrangement" class="form-control" />
          </div>
          <div class="form-group">
            <label for="forget-line-input">遗忘阈值</label>
            <input type="number" id="forget-line-input" v-model="editingDeckFogetLine" class="form-control" />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" id="max-delta-input" v-model="editingDeckMaxDelta" class="form-control" />
          </div>
        </div>
